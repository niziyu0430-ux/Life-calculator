...
if(!['https://life-counter-lab.niziyu0430.chatgpt.site','https://life-counter.cn'].includes(origin))throw new Error('Unsupported site origin');
const paths=['','/play','/about','/privacy','/week-planner','/guides/weekly-time-budget','/guides/small-time-projects','/guides/milestone-calendar','/guides/life-in-weeks','/guides/day-milestones','/guides/date-math'];
