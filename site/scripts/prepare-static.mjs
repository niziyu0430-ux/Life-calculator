...
const paths=['','/about','/privacy','/week-planner','/guides/weekly-time-budget','/guides/small-time-projects','/guides/milestone-calendar','/guides/life-in-weeks','/guides/day-milestones','/guides/date-math'];
